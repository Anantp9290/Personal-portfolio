        ...
        <div className="flex flex-col gap-3">
          <div className="flex gap-4 justify-between items-center">
            ...
            <div className="w-full">
              <div
                className="relative flex flex-col gap-8 before:content-[''] before:absolute before:top-2.5 lg:before:left-1/2 before:left-[100%] before:-translate-x-1/2 before:w-1 before:h-[calc(100%-10px)] before:bg-[#00283a] before:animate-line"
              >
                <div className=" w-full mr-0 relative lg:w-1/2 lg:mr-auto  after:content-[''] after:absolute after:top-[10px] after:right-[-10px] after:w-[20px] after:h-[20px] after:bg-[#00283a] after:rounded-[50%]">
                  <div
                    className=" before:content-[''] before:absolute before:top-[10px] before:right-[-8px] before:w-[20px] before:h-[20px] before:bg-[#00283a] before:rounded-[5px] before:rotate-45 relative h-full  bg-[#00283a] rounded-xl p-6 mr-9 animate-fadeInRight"
                  >
                    <div
                      className=" flex items-center flex-wrap justify-between  md:flex-col md:items-start md:gap-2.5"
                    >
                      <h2
                        className=" text-2xl leading-[38px] font-medium text-white mb-0 md:text-lg md:leading-7"
                      >
                        Meta 
                      </h2>
                      <h6
                        className=" text-base leading-6 font-normal text-[#bdbdbd] mb-0 italic md:text-sm md:leading-6"
                      >
                        Jan - 2017 to May - 2021
                      </h6>
                    </div>
                    <p
                      className=" text-sm leading-6 font-normal text-[#919ca1] mt-6 md:text-xs md:leading-5"
                    >
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
                      libero accusamus quisquam inventore delectus molestiae commodi in,
                      rem aliquam dignissimos, expedita sunt labore possimus, nulla
                      laborum. Maiores ratione nesciunt temporibus voluptatum nisi,
                      dicta facere? Aliquam accusamus iste sint? Velit sapiente illo
                      sit, architecto qui aliquid harum tenetur quisquam saepe
                      necessitatibus.
                    </p>
                  </div>
                </div>
                <div className=" after:content-[''] after:absolute after:top-[10px] lg:after:left-[-10px] after:left-[unset] lg:after:right-[unset] after:right-[-10px] after:w-[20px] after:h-[20px] after:bg-[#00283a] after:rounded-[50%]  w-full ml-0 relative lg:w-1/2 lg:ml-auto">
                  ...
                  >
                    <div
                      className=" flex flex-wrap items-center justify-between mb-2.5 lg:flex-col md:items-start md:gap-2.5"
                    >
                      <h2
                        className=" text-2xl leading-[38px] font-medium text-white mb-0 md:text-lg md:leading-7"
                      >
                      ...
                      <h6
                        className="timeline-card-subhead text-base leading-6 font-normal text-[#bdbdbd] mb-0 italic md:text-sm md:leading-6"
                      >
