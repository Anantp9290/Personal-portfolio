        ...
        <div className="container mx-auto px-5 sm:px-0">
          <div className="flex justify-between items-center bg-[var(--background)] rounded p-5">
            ...
            >
              ...
              <span className="absolute bottom-0 right-0 w-0 h-[2.5px] bg-transparent transition-all duration-1000 ease-in-out group-hover:w-full group-hover:bg-[var(--darkblue)]"></span>
